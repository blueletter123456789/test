...
// 20200822_add start **********************************
		...
		if($param!=1) removeTags($value['id'], $post_tag_name);			//対象記事のタグをリセット処理

		// wp_set_post_tags( $value['id'], $tag, true );	//対象記事のタグを付与処理
		wp_set_post_terms( $value['id'], $tag, $post_tag_name, true );	//対象記事のタグを付与処理		
// 20200822_add end ************************************
	}
}
...
function removeTags($id, $post_tag_name){
	$tags = wp_get_post_terms($id, $post_tag_name);
// 20200822_add end ************************************
...
// 20200822_add start **********************************
	...
	return wp_remove_object_terms($id, $arr,$post_tag_name);
// 20200822_add end ************************************
